...
class TestCallToolPaths:
    ...
    def test_rate_limit_returns_redacted(self, monkeypatch):
        ...
        import mcp_tool_dispatcher  # [8/14 P1 fix] _rate_limit_check lives here (called by _call_tool)
        ...
        # [8/14 P1 fix] mcp_server facade forwards setattr to mcp_tool_dispatcher._rate_limit_check.
        # Direct sub-module setattr also works.
...
class TestRunSSEFullFlow:
    ...
    def test_run_sse_token_load_fail_propagates(self, monkeypatch):
        ...
        # [8/14 P1 fix] mcp_transports.run_sse uses `auth.load_auth_token` direct ref
        # (not facade), so patch auth module directly to make AuthError raise.
        monkeypatch.setattr(_auth_mod, "load_auth_token", _fail_load)
