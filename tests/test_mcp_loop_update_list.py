...
def _setup():
    ...
    try:
        mem._conn.execute("DELETE FROM task_states WHERE task_id LIKE 'loop:tlm12m-%' OR task_id LIKE 'loop:20260806-t12m-%'")
        mem._conn.execute("DELETE FROM entities WHERE id LIKE 'loop:tlm12m-%' OR id LIKE 'loop:20260806-t12m-%'")
    finally:
